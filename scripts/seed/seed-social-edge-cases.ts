...
const MONGO_URI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/devdb';
...
const edgeCasePostContent = [
  ...
  {
    content:
      '#Travel #Adventure #TravelBlog #Wanderlust #TravelGram #InstaTravel #TravelPhotography #Exploring #TravelAddict #TravelDiaries',
