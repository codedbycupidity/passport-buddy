...
async function createSocialFeed() {
  try {
    ...
    const demoUsers = [
      ...
      {
        username: 'jenny_wanderer',
        email: 'jenny@example.com',
        password: 'hashedpassword',
        fullName: 'Jenny Rodriguez',
      },
    ...
    const socialPosts = [
      {
        content:
          "Just landed in Bali! 🏝️ The rice terraces are even more beautiful than the photos. Can't wait to explore Ubud tomorrow!",
        author: createdUsers[0]._id,
        location: { name: 'Bali, Indonesia', latitude: -8.3405, longitude: 115.092 },
        createdAt: new Date(Date.now() - 1 * 60 * 60 * 1000),
      },
      {
        content:
          'Mountain hiking in the Swiss Alps ⛰️ The view from 3000m is absolutely breathtaking. Worth every step of the climb!',
      ...
      {
        content:
          'Airport coffee hits different at 5am ☕ Red-eye flight to Paris but so excited for this spontaneous weekend trip!',
      ...
      {
        content:
          'Street food in Bangkok is next level 🍜 This pad thai from a random cart is better than any restaurant back home!',
      ...
      {
        content:
          'Solo travel update: Currently writing from a café in Prague 🇨🇿 The architecture here is unreal. Every building tells a story!',
        author: createdUsers[1]._id,
      ...
      {
        content:
          'Flight delayed 3 hours but made friends with fellow travelers 😊 Sometimes the best parts of travel are unexpected!',
        author: createdUsers[2]._id,
      ...
      {
        content:
          'Sunset over Santorini 🌅 No filter needed when nature provides this kind of beauty. Greece, you have my heart!',
        author: createdUsers[3]._id,
    ...
    if (beck1) {
      socialPosts.push(
        {
          content:
            'Just landed in Tokyo! 🇯🇵 The flight was incredible and the city lights from above were breathtaking. Ready to explore!',
          author: beck1._id,
        ...
        {
          content:
            'My boarding pass collection is growing! ✈️ Nothing beats the excitement of a new adventure. Where should I go next?',
          author: beck1._id,
