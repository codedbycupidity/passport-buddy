...
describe('Email Service Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        await (0, testHelpers_1.withRetry)(async () => {
            const isHealthy = await (0, testHelpers_1.checkServiceHealth)(API_URL);
            if (!isHealthy) {
    ...
    describe('Email Delivery', () => {
        it('should successfully send test email with retry', async () => {
            ...
            const result = await (0, testHelpers_1.withRetry)(async () => {
                const success = await (0, testHelpers_1.testEmailDelivery)(API_URL, testEmail);
                if (!success) {
