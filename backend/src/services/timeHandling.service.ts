...
const FLIGHT_DURATIONS: Record<string, number> = {
  // Domestic US
  'LAX-JFK': 5.5,
  'JFK-LAX': 6.0, // West-East faster due to jet stream
  'LAX-ORD': 4.0,
  'ORD-LAX': 4.5,
  'JFK-MIA': 3.0,
  'MIA-JFK': 3.0,
 ...
 */
export function parseZonedDateTime(date: Date, timeStr: string, airportCode: string): Date | null {
 ...
 */
export function extractTimesByAirline(text: string, airlineCode: string): Record<string, TimeExtractionResult> {
