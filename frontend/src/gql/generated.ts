...
export type GetPostsQuery = {
  ...
  posts: Array<{
    ...
    likes: Array<string>;
    createdAt: string;
    author?: { __typename?: 'User'; _id: string; username: string; fullName: string; avatar?: string | null } | null;
    images: Array<{ __typename?: 'Image'; url: string; key: string; size: number; mimetype: string }>;
    comments: Array<{
      __typename?: 'Comment';
      _id: string;
      content: string;
...
export function useGetPostsSuspenseQuery(
  baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPostsQuery, GetPostsQueryVariables>
) {
