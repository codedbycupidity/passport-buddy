...
import authService, { AuthError, AuthResponse, OTPResponse, User } from '../services/auth.service';
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signup = async (username: string, email: string, password: string, fullName: string): Promise<AuthResponse> => {
