  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        {['Paris, France', 'Tokyo, Japan', 'New York City', 'Bali, Indonesia', 'London, England', 'Dubai, UAE'].map(
          destination => (
            <div
              key={destination}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                />
                <span style={{ color: 'var(--pb-dark-purple)', fontWeight: '500' }}>{destination}</span>
              </div>
            </div>
          )
        )}
