  ...
  return (
    <div className='auth-error-screen'>
      <div className='auth-error-container'>
        ...
        <h1 className='auth-error-title'>{getErrorTitle()}</h1>
        ...
        <div className='auth-error-actions'>
          {isRecoverable && (
            <button className='auth-error-retry' onClick={onRetry} data-testid='retry-auth-button'>
          ...
          {(errorCode === 'UNAUTHORIZED' || errorCode === 'FORBIDDEN' || !isRecoverable) && onGoToLogin && (
            <button className='auth-error-login' onClick={onGoToLogin}>
        ...
        <div className='auth-error-footer'>
          <p>
            ...
            <a href='mailto:support@yourservice.com' className='auth-error-support-link'>
              Contact Support
            </a>
          </p>
        </div>
