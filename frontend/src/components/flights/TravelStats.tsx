    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ fontWeight: '600', color: 'var(--pb-dark-purple)', fontSize: '0.875rem' }}>
            {(stats.totalDistance || 0) >= 1000
              ? `${((stats.totalDistance || 0) / 1000).toFixed(1)}k`
  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ fontSize: '1.5rem', fontWeight: '700', color: travelLevel.color }}>{travelLevel.level}</div>
      </div>
      ...
      >
        ...
        >
          <div style={{ fontSize: '2rem', fontWeight: '700', color: 'var(--pb-dark-purple)' }}>{flightHours}</div>
      ...
      {showGoals && (
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <TravelGoal goal='Visit 10 new countries' current={stats.uniqueCountries} target={10} />
            <TravelGoal goal='Fly 50,000 miles' current={stats.totalDistance} target={50000} />
            <TravelGoal goal='Take 20 flights' current={stats.totalFlights} target={20} />
          </div>
        </div>
      )}
    </div>
