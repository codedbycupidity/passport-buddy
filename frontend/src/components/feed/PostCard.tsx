    ...
    <article className='post-card'>
      ...
      <header className='post-header'>
        ...
        {currentUserId && post.author?._id === currentUserId && (
          <div className='post-menu-container' ref={postDropdownRef}>
            <button className='post-options' aria-label='Post options' onClick={() => setShowPostMenu(!showPostMenu)}>
      ...
      {hasMedia && (
        <div className='post-media'>
          <div className='image-container' onClick={hasVideos ? undefined : handleDoubleTap}>
            ...
            {hasMultipleImages && (
              <>
                <button className='image-nav image-nav-prev' onClick={handlePrevImage} aria-label='Previous image'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none'>
                    <path
                      d='M15 18L9 12L15 6'
                      stroke='currentColor'
                ...
                <button className='image-nav image-nav-next' onClick={handleNextImage} aria-label='Next image'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none'>
                    <path
                      d='M9 18L15 12L9 6'
                      stroke='currentColor'
      ...
      <div className='post-actions'>
        <div className='actions-left'>
          <button className='action-button' aria-label='Like' onClick={handleLikeClick} disabled={isLiking}>
            <svg
              width='24'
              height='24'
              viewBox='0 0 24 24'
          ...
          <button className='action-button' aria-label='Comment' onClick={() => setShowComments(!showComments)}>
            <svg width='24' height='24' viewBox='0 0 24 24' fill='none'>
              <path
          ...
          {showCopiedMessage && <div className='copied-message'>Link copied!</div>}
        </div>
        <button className='action-button' aria-label='Save' onClick={handleBookmarkClick} disabled={isBookmarking}>
      ...
      <div className='post-stats'>
        ...
        {post.comments.length > 0 && (
          <button className='comments-count' onClick={() => setShowComments(!showComments)}>
