...
import { PexelsPhoto, pexelsService } from '../services/pexels.service';
      ...
      >
        ...
        {loading && (
          ...
          >
            ...
            ></div>
            <p style={{ marginTop: '1rem', color: 'var(--pb-medium-purple)' }}>Loading amazing photos...</p>
          </div>
        )}
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '2rem' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: '600', marginBottom: '1rem', color: '#333' }}>Search</h1>
