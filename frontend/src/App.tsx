...
const StressTestPanel = lazy(() =>
  import('./components/dev/StressTestPanel').then(module => ({ default: module.StressTestPanel }))
);
...
const AppContent: React.FC = () => {
  ...
  return (
    <div style={{ backgroundColor: 'var(--pb-background)', minHeight: '100vh' }}>
      ...
      {(window as any).__DEMO_MODE__ && <DemoModeNotification />}
