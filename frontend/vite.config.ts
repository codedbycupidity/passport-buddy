  ...
  define: {
    ...
    'import.meta.env.VITE_GRAPHQL_URL': JSON.stringify(
      process.env.VITE_GRAPHQL_URL ||
        (process.env.NODE_ENV === 'production' ? 'https://www.xbullet.me/graphql' : 'http://localhost:3000/graphql')
    ),
    'import.meta.env.VITE_API_URL': JSON.stringify(
      process.env.VITE_API_URL ||
        (process.env.NODE_ENV === 'production' ? 'https://www.xbullet.me' : 'http://localhost:3000')
    ),
